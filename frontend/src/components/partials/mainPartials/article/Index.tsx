    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Menghadirkan informasi terbaru seputar wisata, dan hal menarik
          lainnya.
        </p>
      </div>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground mb-4">
                Tidak ada artikel yang sesuai dengan pencarian Anda. Coba kata
                kunci lain atau filter yang berbeda.
              </p>
              <Button
                onClick={() => {
                  handleSearch("");
        ...
        categoryFilter === "all" && (
          <div className="bg-blue-50 rounded-xl p-8 text-center my-8">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Kami sedang bekerja keras untuk menyiapkan artikel yang menarik
              untuk Anda. Silakan kembali lagi nanti untuk melihat konten
              terbaru kami!
            </p>
          </div>
        )}
